...
(define write-word (make-ffi "write_word" (_fun _uint16 _uint16 -> _void)))
...
(define reset-6502 (make-ffi "reset6502" (_fun -> _void)))
(define get-label (make-ffi "get_label" (_fun _string -> _uint16)))
(define (get-status)
  (get-ffi-obj "status" library-name _uint8))
(define (get-sp)
  (get-ffi-obj "sp" library-name _uint8))
(define (get-x)
  (get-ffi-obj "x" library-name _uint8))
(define (get-y)
  (get-ffi-obj "y" library-name _uint8))
(define (get-a)
  (get-ffi-obj "a" library-name _uint8))
(define (get-pc)
  (get-ffi-obj "pc" library-name _uint16))
(define (set-pc address)
  (set-ffi-obj! "pc" library-name _uint16 address))
